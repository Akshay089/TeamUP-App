    ...
    <SafeAreaView className="flex-1 bg-slate-50">
      ...
      >
        ...
        >
          ...
          <View className="px-5">
            <Text className="text-3xl font-bold text-slate-900">Create your workspace</Text>
            <Text className="text-slate-500 mt-2 text-base leading-6">
              One profile for bookings, payments, and venue communications.
            </Text>
            ...
            <Image
              source={wbimage2}
              className="w-full h-52 mt-8 rounded-3xl"
              resizeMode="cover"
            />
          </View>
        </ScrollView>
